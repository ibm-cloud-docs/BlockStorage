...
2. Klicken Sie auf die Registerkarte **Konfiguration**.
    ...
    {:important}
         - Löschen Sie im Feld **Name** alle vorhandenen Einträge und geben Sie den Benutzernamen aus der [{{site.data.keyword.cloud_notm}}-Konsole](https://{DomainName}/classic/storage){: external} ein.
         - Geben Sie im Feld **Geheimer Zielschlüssel** das Kennwort aus der [{{site.data.keyword.cloud_notm}}-Konsole](https://{DomainName}/classic/storage){: external} ein.
