...
レプリケーションは、スナップショット・スケジュールに基づいて作動します。 レプリケーションを行うには、まずソース・ボリューム用のスナップショット・スペースとスナップショット・スケジュールを作成する必要があります。 レプリケーションを設定しようとしたときに、どちらかの準備ができていなければ、より多くのスペースを購入するか、スケジュールを設定するように求められます。 レプリケーションは、[{{site.data.keyword.slportal}}](https://control.softlayer.com/){: external}の**「ストレージ」**の**「{{site.data.keyword.blockstorageshort}}」**で管理されます。
...
[{{site.data.keyword.slportal}}](https://control.softlayer.com/){: external}で、**「ストレージ」**の**「{{site.data.keyword.blockstorageshort}}」**にある**「プライマリー」**または**「レプリカ」**のいずれかのタブから、レプリケーション・スケジュールを編集したり、レプリケーション・スペースを変更したりできます。
