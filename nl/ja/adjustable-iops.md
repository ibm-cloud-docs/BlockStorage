...
- 元のボリュームが 0.30 IOPS/GB 未満の「パフォーマンス」ある場合、使用可能なオプションには、0.30 IOPS/GB 未満になるサイズと IOPS の組み合わせのみが含まれます。
- 元のボリュームが 0.30 IOPS/GB 以上の「パフォーマンス」である場合、使用可能なオプションには、0.30 IOPS/GB 以上になるサイズと IOPS の組み合わせのみが含まれます。
