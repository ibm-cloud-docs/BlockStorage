...
2. Seleziona il volume iSCSI dall'elenco e fai clic su **...** > **Modify LUN**
3. In **Adjust Storage IOPS**, effettua una nuova selezione:
    ...
    {:tip}
4. Riesamina la tua selezione e i dettagli del prezzo.
