...
[{{site.data.keyword.slportal}} ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://control.softlayer.com/){:new_window}의 **스토리지** **{{site.data.keyword.blockstorageshort}}**에 있는 **1차** 또는 **복제본**에서 복제 스케줄을 편집하고 복제본 영역을 변경할 수 있습니다.
...
* 1차 위치에 위험이 임박한 경우 [액세스 가능한 1차 볼륨으로 장애 복구](dr-accessible-primary.html)를 참조하십시오.
* 1차 위치가 완전히 작동 중지된 경우 [액세스할 수 없는 1차 볼륨으로 장애 복구](disaster-recovery.html)를 참조하십시오.
