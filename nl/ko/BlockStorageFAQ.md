...
[{{site.data.keyword.slportal}}](https://control.softlayer.com/){:new_window}의 {{site.data.keyword.blockstorageshort}} 리스트를 보면 암호화된 LUN/볼륨의 LUN/볼륨 이름 오른쪽에 잠금 아이콘이 표시됩니다.
