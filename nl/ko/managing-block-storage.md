...
1. **스토리지** > **{{site.data.keyword.blockstorageshort}}**를 클릭한 후 볼륨 이름을 클릭하십시오.
...
1. [{{site.data.keyword.cloud}} 콘솔](https://{DomainName}/classic){: external}에서 클래식 인프라 아이콘을 클릭하십시오. 그런 다음 **디바이스**, **디바이스 목록**을 클릭한 후 적절한 디바이스를 두 번 클릭하십시오.
2. **스토리지** 탭을 선택하십시오.
3. 이 특정 호스트가 액세스할 수 있는 스토리지 목록이 표시됩니다. 목록은 스토리지 유형(블록, 파일, 기타)별로 그룹화되어 표시됩니다. 볼륨 이름 옆에 있는 **조치**를 클릭한 후 **액세스 취소**를 클릭하십시오.
...
1. **스토리지**, **{{site.data.keyword.blockstorageshort}}**를 클릭하십시오.
2. 취소할 볼륨을 선택하고 **조치**를 클릭한 후 **{{site.data.keyword.blockstorageshort}} 취소**를 선택하십시오.
