...
*Por ejemplo, su respuesta podría ser similar a un nuevo almacén de datos de máquina virtual, un nuevo entorno de desarrollo/pruebas, una base de datos SQL o un registro.*
