...
### ¿Cómo se añade una planificación de instantáneas?
...
3. Pulse **Guardar** y cree otra planificación con una frecuencia diferente. Si el número total de instantáneas planificadas supera las 50, recibirá un mensaje de aviso y no podrá guardar.

Las instantáneas de la lista se muestran tal como se han tomado en la sección **Instantáneas** de la página **Detalles**.

## ¿Cómo se realiza una instantánea manual?

Las instantáneas manuales se pueden realizar en distintos puntos durante una actualización o mantenimiento de la aplicación. También puede realizar instantáneas en varias máquinas que se hayan desactivado temporalmente a nivel de aplicación.
...
Se realiza la instantánea y se muestra en la sección **Instantáneas** de la página **Detalles**. Su planificación será Manual.

## ¿Cómo puedo ver una lista de instantáneas con el espacio utilizado y funciones de gestión?
...
## ¿Cómo se visualiza una lista de instantáneas retenidas?
...
## ¿Cómo puedo ver la cantidad de espacio de instantáneas utilizado?

El gráfico circular en la parte superior de la página **Detalles** muestra la cantidad de espacio que se ha utilizado y la cantidad de espacio que queda. Recibirá notificaciones cuando empiece a alcanzar los umbrales de espacio: 75 %, 90 % y 95 %.

## ¿Cómo se cambia la cantidad de espacio de instantáneas para mi volumen?
...
**Nota**: El espacio de instantáneas sólo se puede aumentar, no reducir. Le conviene seleccionar una cantidad de espacio inferior hasta que determine cuánto espacio necesita realmente. Recuerde que las instantáneas automatizadas y manuales comparten el espacio.
...
2. Pulse **Acciones** junto a una instantánea particular y pulse **Suprimir** para suprimir la instantánea. Esto no afectará a ninguna instantánea anterior ni futura de la misma planificación, ya que no existe dependencia entre instantáneas.
...
## ¿Cómo restauro mi volumen de almacenamiento a un punto en el tiempo específico utilizando una instantánea?
...
4. Pulse **Acciones** junto a la instantánea que se va a utilizar y pulse **Restaurar**. <br/>
  **Nota**: la realización de una restauración provocará la pérdida de los datos que se hayan creado o modificado desde que la instantánea utilizada se creó. Una termine, el volumen de almacenamiento volverá al mismo estado que cuando se realizó la instantánea. 
