...
Uma lista de capturas instantâneas retidas e o espaço usado podem ser vistos na página **Detalhe** (Armazenamento, {{site.data.keyword.blockstorageshort}}). As funções de gerenciamento (editando planejamentos e incluindo mais espaço) são conduzidas na página Detalhe usando o menu **Ações** ou links nas várias seções na página.
...
**Nota**: o espaço de captura instantânea só pode ser aumentado. Ele não pode ser reduzido. Será possível selecionar uma quantia menor de espaço até você determinar quanto espaço realmente é necessário. Lembre-se, capturas instantâneas automatizadas e manuais compartilham o espaço.
