...
Storage that is provisioned on updated storage in these data centers prior to release of this feature (December 14, 2017)  can only be increased to 10x its original size.  All other storage provisioned, after that date can be increased up to the max 12 TB size. 
