...
If snapshot space utilization occurs too rapidly, then you might receive one notification before auto-deletion of the oldest scheduled snapshot occurs. For example, if utilization jumps from 76% to 96% in 10  minutes, you receive one notification about exceeding 75% and one notification about exceeding 95%.
{: note}
