...
2. Click the **Configuration** tab.
   ...
   - In the **Name** field, delete any existing entries and input the user name from the [{{site.data.keyword.cloud_notm}} console](/classic/storage/block){: external}. This field is case-sensitive
   - In the **Target secret** field, enter the password from the [{{site.data.keyword.cloud_notm}} console](/classic/storage/block){: external}. This field is case-sensitive.
...
7. In the Advanced Settings window,
    ...
    [^SecondIP]: You can find the second IP address in the **{{site.data.keyword.blockstorageshort}} Detail** screen in the [{{site.data.keyword.cloud_notm}} console](/classic/storage/block){: external}.
