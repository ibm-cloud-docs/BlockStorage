...
For more information about Ubuntu specifics, see [iSCSI Initiator Configuration](https://ubuntu.com/server/docs/service-iscsi){: external} and [DM-Multipath](https://ubuntu.com/server/docs/configuring-device-mapper-multipathing){: external}.
