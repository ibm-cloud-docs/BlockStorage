...
You can edit your replication schedule and change your replication space from either the **Primary** or **Replica** tab under **Storage**, **{{site.data.keyword.blockstorageshort}}** from the [Customer Portal](https://control.softlayer.com/){:new_window}.
...
Failovers are initiated under **Storage**, **{{site.data.keyword.blockstorageshort}}** from the [Customer Portal](https://control.softlayer.com/){:new_window}.
...
Fallbacks are initiated under **Storage**, **{{site.data.keyword.blockstorageshort}}** from the [Customer Portal](https://control.softlayer.com/){:new_window}.
