...
Data centers in US 1 region can only replicate with each other. Compute hosts in data centers within the US 2 region can't start replication with replica targets in US 1 data centers.
{: note}
